...
if(isset($_POST['submit'])) {
    ...
    if(!$firstname) {
        ...
        // chect if passwords don't match
        if($createpassword !== $confirmpassword) {
            $_SESSION['signup'] = "Paswords do not match";
        } else {
            // hash password
            ...
            if(mysqli_num_rows($user_check_result) > 0) {
                ...
                $allowrd_files = ['png', 'jpg', 'jpeg'];
                $extention  = explode('.', $avatar_name);
                $extention = end($extention);
                if(in_array($extention, $allowrd_files)) {
    ...
    if ($_SESSION['signup']) {
        ...
        $inset_user_query = "INSERT INTO users 
        ...
        if(!mysqli_errno($connection)) {
            ...
            $_SESSION['signup-success'] = "Registration successful, plz login";
